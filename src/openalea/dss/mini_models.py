...
def contamination_risk(weather, time_sequence):
    """a very simple index of contamination risk over the period in weather"""
    ...
    index = sum(map(lambda(x): leaf_wetness_rapilly(*x), zip(rain, relative_humidity, ppfd)))
    return index
