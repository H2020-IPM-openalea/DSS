...
__all__ = ['ipmdecisions_dss_de_ISIP_siggetreide_siggetreide']



ipmdecisions_dss_de_ISIP_siggetreide_siggetreide = Factory(name='siggetreide',
                ...
                category=None,
                nodemodule='ipmdecisions.dss.de.ISIP.siggetreide',
