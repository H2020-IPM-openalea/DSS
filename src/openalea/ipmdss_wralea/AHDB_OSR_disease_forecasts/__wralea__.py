...
__all__ = ['openalea_ipmdss_wralea_AHDB_OSR_disease_forecasts_SCLESC_SCLESC', 'openalea_ipmdss_wralea_AHDB_OSR_disease_forecasts_LEPTMA_LEPTMA']



openalea_ipmdss_wralea_AHDB_OSR_disease_forecasts_SCLESC_SCLESC = Factory(name='SCLESC',
                ...
                nodemodule='openalea.ipmdss_wralea.AHDB_OSR_disease_forecasts.SCLESC',
                nodeclass='SCLESC',
                inputs=[],
...
openalea_ipmdss_wralea_AHDB_OSR_disease_forecasts_LEPTMA_LEPTMA = Factory(name='LEPTMA',
                authors='Agriculture and Horticulture Development Board (wralea authors)',
                ...
                nodemodule='openalea.ipmdss_wralea.AHDB_OSR_disease_forecasts.LEPTMA',
                nodeclass='LEPTMA',
                inputs=[],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
