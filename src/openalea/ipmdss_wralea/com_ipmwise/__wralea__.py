...
__all__ = ['ipmdecisions_dss_com_ipmwise_ipmwiseDK_ipmwiseDK', 'ipmdecisions_dss_com_ipmwise_ipmwiseNO_ipmwiseNO', 'ipmdecisions_dss_com_ipmwise_ipmwiseES_ipmwiseES', 'ipmdecisions_dss_com_ipmwise_ipmwiseDEMO_ipmwiseDEMO']



ipmdecisions_dss_com_ipmwise_ipmwiseDK_ipmwiseDK = Factory(name='ipmwiseDK',
                ...
                nodemodule='ipmdecisions.dss.com.ipmwise.ipmwiseDK',
                nodeclass='ipmwiseDK',
                inputs=[],
...
ipmdecisions_dss_com_ipmwise_ipmwiseNO_ipmwiseNO = Factory(name='ipmwiseNO',
                authors='IPM Consult ApS (wralea authors)',
                ...
                category='weeds, herbicides, tank mixtures, dose, recommendation, efficacy, cost, timing, weed density, weed size, weed species, crop growthstage, autumn sown crops, spring sown crops, IPM, IWM, efficacy tables, Field-Specific Crop Management, Integrated weed control, Legislative framework, Crop Protection Online, Dose-response curves',
                nodemodule='ipmdecisions.dss.com.ipmwise.ipmwiseNO',
                nodeclass='ipmwiseNO',
                inputs=[],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
...
ipmdecisions_dss_com_ipmwise_ipmwiseES_ipmwiseES = Factory(name='ipmwiseES',
                authors='IPM Consult ApS (wralea authors)',
                ...
                category='weeds, herbicides, tank mixtures, dose, recommendation, efficacy, cost, timing, weed density, weed size, weed species, crop growthstage, autumn sown crops, spring sown crops, IPM, IWM, efficacy tables, Field-Specific Crop Management, Integrated weed control, Legislative framework, Crop Protection Online, Dose-response curves',
                nodemodule='ipmdecisions.dss.com.ipmwise.ipmwiseES',
                nodeclass='ipmwiseES',
                inputs=[],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
...
ipmdecisions_dss_com_ipmwise_ipmwiseDEMO_ipmwiseDEMO = Factory(name='ipmwiseDEMO',
                authors='IPM Consult ApS (wralea authors)',
                ...
                category='weeds, herbicides, tank mixtures, dose, recommendation, efficacy, cost, timing, weed density, weed size, weed species, crop growthstage, autumn sown crops, spring sown crops, IPM, IWM, efficacy tables, Field-Specific Crop Management, Integrated weed control, Legislative framework, Crop Protection Online, Dose-response curves',
                nodemodule='ipmdecisions.dss.com.ipmwise.ipmwiseDEMO',
