...
__all__ = ['ipmdecisions_dss_nl_wur_LateBlight_BlightApp_BlightApp']



ipmdecisions_dss_nl_wur_LateBlight_BlightApp_BlightApp = Factory(name='BlightApp',
                ...
                nodemodule='ipmdecisions.dss.nl.wur.LateBlight.BlightApp',
                nodeclass='BlightApp',
