...
__all__ = ['openalea_ipmdss_wralea_uk_WarwickHRI_LAMTEQ_LAMTEQ', 'openalea_ipmdss_wralea_uk_WarwickHRI_MELIAE_MELIAE', 'openalea_ipmdss_wralea_uk_WarwickHRI_HYLERA_HYLERA', 'openalea_ipmdss_wralea_uk_WarwickHRI_PSILRO_PSILRO']



openalea_ipmdss_wralea_uk_WarwickHRI_LAMTEQ_LAMTEQ = Factory(name='LAMTEQ',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.uk_WarwickHRI.LAMTEQ',
                nodeclass='LAMTEQ',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 1102}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
...
openalea_ipmdss_wralea_uk_WarwickHRI_MELIAE_MELIAE = Factory(name='MELIAE',
                authors='University of Warwick (Warwick Crop Centre) (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.uk_WarwickHRI.MELIAE',
                nodeclass='MELIAE',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 1102}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
...
openalea_ipmdss_wralea_uk_WarwickHRI_HYLERA_HYLERA = Factory(name='HYLERA',
                authors='University of Warwick (Warwick Crop Centre) (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.uk_WarwickHRI.HYLERA',
                nodeclass='HYLERA',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 1102}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
...
openalea_ipmdss_wralea_uk_WarwickHRI_PSILRO_PSILRO = Factory(name='PSILRO',
                authors='University of Warwick (Warwick Crop Centre) (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.uk_WarwickHRI.PSILRO',
                nodeclass='PSILRO',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 1102}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
