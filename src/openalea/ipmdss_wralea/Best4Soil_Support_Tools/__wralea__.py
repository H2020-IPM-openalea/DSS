...
__all__ = ['ipmdecisions_dss_Best4Soil_Support_Tools_nematodes_nematodes', 'ipmdecisions_dss_Best4Soil_Support_Tools_pathogens_pathogens']



ipmdecisions_dss_Best4Soil_Support_Tools_nematodes_nematodes = Factory(name='nematodes',
                ...
                category=None,
                nodemodule='ipmdecisions.dss.Best4Soil.Support.Tools.nematodes',
                nodeclass='nematodes',
...
ipmdecisions_dss_Best4Soil_Support_Tools_pathogens_pathogens = Factory(name='pathogens',
                authors='Wageningen University and Research (wralea authors)',
                ...
                nodemodule='ipmdecisions.dss.Best4Soil.Support.Tools.pathogens',
                nodeclass='pathogens',
                inputs=[{'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
