...
def YellowRustGeneticGroupFrequency(weathersource, timestart='2022-03-01', timeend='2022-08-01'):
    ...
    h= Manager()
    _model= h.get_model("dk.au.agro", "YellowRustGeneticGroupFrequency")
