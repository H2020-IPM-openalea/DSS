...
__all__ = ['ipmdecisions_dss_adas_datamanipulation_CIBSEsingleday_CIBSEsingleday', 'ipmdecisions_dss_adas_datamanipulation_CIBSEmultipledays_CIBSEmultipledays', 'ipmdecisions_dss_adas_datamanipulation_Sin14R_1singleday_Sin14R_1singleday', 'ipmdecisions_dss_adas_datamanipulation_Sin14R_1multipledays_Sin14R_1multipledays', 'ipmdecisions_dss_adas_datamanipulation_Hourly_RH_Hourly_RH', 'ipmdecisions_dss_adas_datamanipulation_LeafWetnessDuration_RH_LeafWetnessDuration_RH', 'ipmdecisions_dss_adas_datamanipulation_LeafWetnessDuration_LeafWetnessDuration']



ipmdecisions_dss_adas_datamanipulation_CIBSEsingleday_CIBSEsingleday = Factory(name='CIBSEsingleday',
                ...
                nodemodule='ipmdecisions.dss.adas.datamanipulation.CIBSEsingleday',
...
ipmdecisions_dss_adas_datamanipulation_CIBSEmultipledays_CIBSEmultipledays = Factory(name='CIBSEmultipledays',
                authors='ADAS (wralea authors)',
                ...
                category='algorithm, temperature',
                nodemodule='ipmdecisions.dss.adas.datamanipulation.CIBSEmultipledays',
...
ipmdecisions_dss_adas_datamanipulation_Sin14R_1singleday_Sin14R_1singleday = Factory(name='Sin14R_1singleday',
                authors='ADAS (wralea authors)',
                ...
                category='algorithm, temperature',
                nodemodule='ipmdecisions.dss.adas.datamanipulation.Sin14R_1singleday',
...
ipmdecisions_dss_adas_datamanipulation_Sin14R_1multipledays_Sin14R_1multipledays = Factory(name='Sin14R_1multipledays',
                authors='ADAS (wralea authors)',
                ...
                category='algorithm, temperature',
                nodemodule='ipmdecisions.dss.adas.datamanipulation.Sin14R_1multipledays',
...
ipmdecisions_dss_adas_datamanipulation_Hourly_RH_Hourly_RH = Factory(name='Hourly_RH',
                authors='ADAS (wralea authors)',
                ...
                nodemodule='ipmdecisions.dss.adas.datamanipulation.Hourly_RH',
                nodeclass='Hourly_RH',
                inputs=[],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
...
ipmdecisions_dss_adas_datamanipulation_LeafWetnessDuration_RH_LeafWetnessDuration_RH = Factory(name='LeafWetnessDuration_RH',
                authors='ADAS (wralea authors)',
                ...
                category='algorithm',
                nodemodule='ipmdecisions.dss.adas.datamanipulation.LeafWetnessDuration_RH',
...
ipmdecisions_dss_adas_datamanipulation_LeafWetnessDuration_LeafWetnessDuration = Factory(name='LeafWetnessDuration',
                authors='ADAS (wralea authors)',
                ...
                category='algorithm',
                nodemodule='ipmdecisions.dss.adas.datamanipulation.LeafWetnessDuration',
