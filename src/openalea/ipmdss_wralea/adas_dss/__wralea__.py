...
__all__ = ['openalea_ipmdss_wralea_adas_dss_DASGPA_DASGPA', 'openalea_ipmdss_wralea_adas_dss_SITDMO_SITDMO', 'openalea_ipmdss_wralea_adas_dss_MELIAE_MELIAE', 'openalea_ipmdss_wralea_adas_dss_HAPDMA_HAPDMA', 'openalea_ipmdss_wralea_adas_dss_CARPPO_CARPPO', 'openalea_ipmdss_wralea_adas_dss_RHOPPA_RHOPPA', 'openalea_ipmdss_wralea_adas_dss_PHYTIN_PHYTIN', 'openalea_ipmdss_wralea_adas_dss_SEPTTR_SEPTTR', 'openalea_ipmdss_wralea_adas_dss_DEROAG_Cereals_DEROAG_Cereals', 'openalea_ipmdss_wralea_adas_dss_DEROAG_OSR_DEROAG_OSR', 'openalea_ipmdss_wralea_adas_dss_IPMTOOL_IPMTOOL']



openalea_ipmdss_wralea_adas_dss_DASGPA_DASGPA = Factory(name='DASGPA',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.DASGPA',
                nodeclass='DASGPA',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 2001}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
...
openalea_ipmdss_wralea_adas_dss_SITDMO_SITDMO = Factory(name='SITDMO',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.SITDMO',
                nodeclass='SITDMO',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 2001}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
...
openalea_ipmdss_wralea_adas_dss_MELIAE_MELIAE = Factory(name='MELIAE',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.MELIAE',
                nodeclass='MELIAE',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1004}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
openalea_ipmdss_wralea_adas_dss_HAPDMA_HAPDMA = Factory(name='HAPDMA',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.HAPDMA',
                nodeclass='HAPDMA',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 2001}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
...
openalea_ipmdss_wralea_adas_dss_CARPPO_CARPPO = Factory(name='CARPPO',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.CARPPO',
                nodeclass='CARPPO',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1003}, {'name': 'p2', 'interface': IInt, 'value': 1004}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
openalea_ipmdss_wralea_adas_dss_RHOPPA_RHOPPA = Factory(name='RHOPPA',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.RHOPPA',
                nodeclass='RHOPPA',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1001}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
openalea_ipmdss_wralea_adas_dss_PHYTIN_PHYTIN = Factory(name='PHYTIN',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.PHYTIN',
                nodeclass='PHYTIN',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1001}, {'name': 'p2', 'interface': IInt, 'value': 3001}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
openalea_ipmdss_wralea_adas_dss_SEPTTR_SEPTTR = Factory(name='SEPTTR',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.SEPTTR',
                nodeclass='SEPTTR',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'p1', 'interface': IInt, 'value': 1003}, {'name': 'p2', 'interface': IInt, 'value': 2001}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
openalea_ipmdss_wralea_adas_dss_DEROAG_Cereals_DEROAG_Cereals = Factory(name='DEROAG_Cereals',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.DEROAG_Cereals',
                nodeclass='DEROAG_Cereals',
                inputs=[{'name': 'WeatherSource', 'value': None}, {'name': 'species', 'interface': ISequence, 'value': ['DEROAG']}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
openalea_ipmdss_wralea_adas_dss_DEROAG_OSR_DEROAG_OSR = Factory(name='DEROAG_OSR',
                authors='ADAS (wralea authors)',
                ...
                category='none',
                nodemodule='openalea.ipmdss_wralea.adas_dss.DEROAG_OSR',
...
openalea_ipmdss_wralea_adas_dss_IPMTOOL_IPMTOOL = Factory(name='IPMTOOL',
                authors='ADAS (wralea authors)',
                ...
                category=None,
                nodemodule='openalea.ipmdss_wralea.adas_dss.IPMTOOL',
                nodeclass='IPMTOOL',
