...
__all__ = ['ipmdecisions_dss_no_nibio_vips_PSILARTEMP_PSILARTEMP', 'ipmdecisions_dss_no_nibio_vips_DELIARADIC_DELIARADIC', 'ipmdecisions_dss_no_nibio_vips_MAMESTRABR_MAMESTRABR', 'ipmdecisions_dss_no_nibio_vips_PSILAROBSE_PSILAROBSE', 'ipmdecisions_dss_no_nibio_vips_DELIARFOBS_DELIARFOBS', 'ipmdecisions_dss_no_nibio_vips_NAERSTADMO_NAERSTADMO', 'ipmdecisions_dss_no_nibio_vips_ALTERNARIA_ALTERNARIA', 'ipmdecisions_dss_no_nibio_vips_NEGPROGMOD_NEGPROGMOD', 'ipmdecisions_dss_no_nibio_vips_SEPAPIICOL_SEPAPIICOL', 'ipmdecisions_dss_no_nibio_vips_BREMIALACT_BREMIALACT']



ipmdecisions_dss_no_nibio_vips_PSILARTEMP_PSILARTEMP = Factory(name='PSILARTEMP',
                ...
                category='none',
                nodemodule='ipmdecisions.dss.no.nibio.vips.PSILARTEMP',
                nodeclass='PSILARTEMP',
                inputs=[{'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
...
ipmdecisions_dss_no_nibio_vips_DELIARADIC_DELIARADIC = Factory(name='DELIARADIC',
                authors='NIBIO (wralea authors)',
                ...
                category='none',
                nodemodule='ipmdecisions.dss.no.nibio.vips.DELIARADIC',
                nodeclass='DELIARADIC',
                inputs=[{'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 1112}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
ipmdecisions_dss_no_nibio_vips_MAMESTRABR_MAMESTRABR = Factory(name='MAMESTRABR',
                authors='NIBIO (wralea authors)',
                ...
                category='none',
                nodemodule='ipmdecisions.dss.no.nibio.vips.MAMESTRABR',
...
ipmdecisions_dss_no_nibio_vips_PSILAROBSE_PSILAROBSE = Factory(name='PSILAROBSE',
                authors='NIBIO (wralea authors)',
                ...
                category='none',
                nodemodule='ipmdecisions.dss.no.nibio.vips.PSILAROBSE',
                nodeclass='PSILAROBSE',
                inputs=[{'name': 'species', 'interface': ISequence, 'value': ['PSILRO']}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
ipmdecisions_dss_no_nibio_vips_DELIARFOBS_DELIARFOBS = Factory(name='DELIARFOBS',
                authors='NIBIO (wralea authors)',
                ...
                category=None,
                nodemodule='ipmdecisions.dss.no.nibio.vips.DELIARFOBS',
                nodeclass='DELIARFOBS',
                inputs=[{'name': 'species', 'interface': ISequence, 'value': ['HYLERA', 'HYLEFL']}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
ipmdecisions_dss_no_nibio_vips_NAERSTADMO_NAERSTADMO = Factory(name='NAERSTADMO',
                authors='NIBIO (wralea authors)',
                ...
                category=None,
                nodemodule='ipmdecisions.dss.no.nibio.vips.NAERSTADMO',
                nodeclass='NAERSTADMO',
                inputs=[{'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 2001}, {'name': 'p3', 'interface': IInt, 'value': 5001}, {'name': 'p4', 'interface': IInt, 'value': 3002}, {'name': 'p5', 'interface': IInt, 'value': 3101}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
ipmdecisions_dss_no_nibio_vips_ALTERNARIA_ALTERNARIA = Factory(name='ALTERNARIA',
                authors='NIBIO (wralea authors)',
                ...
                category=None,
                nodemodule='ipmdecisions.dss.no.nibio.vips.ALTERNARIA',
                nodeclass='ALTERNARIA',
                inputs=[{'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 3101}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
ipmdecisions_dss_no_nibio_vips_NEGPROGMOD_NEGPROGMOD = Factory(name='NEGPROGMOD',
                authors='NIBIO (wralea authors)',
                ...
                category=None,
                nodemodule='ipmdecisions.dss.no.nibio.vips.NEGPROGMOD',
                nodeclass='NEGPROGMOD',
                inputs=[{'name': 'p1', 'interface': IInt, 'value': 1002}, {'name': 'p2', 'interface': IInt, 'value': 2001}, {'name': 'p3', 'interface': IInt, 'value': 3002}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
ipmdecisions_dss_no_nibio_vips_SEPAPIICOL_SEPAPIICOL = Factory(name='SEPAPIICOL',
                authors='NIBIO (wralea authors)',
                ...
                category=None,
                nodemodule='ipmdecisions.dss.no.nibio.vips.SEPAPIICOL',
                nodeclass='SEPAPIICOL',
                inputs=[{'name': 'p1', 'interface': IInt, 'value': 3101}, {'name': 'p2', 'interface': IInt, 'value': 1002}, {'name': 'p3', 'interface': IInt, 'value': 2001}, {'name': 'p4', 'interface': IInt, 'value': 3002}, {'name': 'species', 'interface': ISequence, 'value': ['SEPTAP']}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
...
ipmdecisions_dss_no_nibio_vips_BREMIALACT_BREMIALACT = Factory(name='BREMIALACT',
                authors='NIBIO (wralea authors)',
                ...
                category='none',
                nodemodule='ipmdecisions.dss.no.nibio.vips.BREMIALACT',
                nodeclass='BREMIALACT',
                inputs=[{'name': 'p1', 'interface': IInt, 'value': 1004}, {'name': 'p2', 'interface': IInt, 'value': 3103}, {'name': 'p3', 'interface': IInt, 'value': 5001}, {'name': 'p4', 'interface': IInt, 'value': 3002}, {'name': 'timeStart', 'interface': IDateTime, 'value': '2022-03-01'}, {'name': 'timeEnd', 'interface': IDateTime, 'value': '2022-08-01'}],
                outputs=({'name': 'result', 'interface': IStr},),
                widgetmodule=None,
                widgetclass=None,
               )
