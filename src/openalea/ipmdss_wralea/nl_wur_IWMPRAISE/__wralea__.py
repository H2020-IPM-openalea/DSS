...
__all__ = ['openalea_ipmdss_wralea_nl_wur_IWMPRAISE_IWMPRAISE_Tool_IWMPRAISE_Tool']



openalea_ipmdss_wralea_nl_wur_IWMPRAISE_IWMPRAISE_Tool_IWMPRAISE_Tool = Factory(name='IWMPRAISE_Tool',
                ...
                nodemodule='openalea.ipmdss_wralea.nl_wur_IWMPRAISE.IWMPRAISE_Tool',
