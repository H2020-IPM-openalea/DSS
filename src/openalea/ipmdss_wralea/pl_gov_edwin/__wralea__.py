...
__all__ = ['ipmdecisions_dss_pl_gov_edwin_eDWIN_LINK_eDWIN_LINK']



ipmdecisions_dss_pl_gov_edwin_eDWIN_LINK_eDWIN_LINK = Factory(name='eDWIN_LINK',
                ...
                category='',
                nodemodule='ipmdecisions.dss.pl.gov.edwin.eDWIN_LINK',
